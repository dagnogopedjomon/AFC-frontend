...
export default function LoginPage() {
  ...
  return (
    <div className={dark ? 'dark' : ''}>
      <div className="min-h-screen bg-[#f7f9fb] text-[#172033] lg:grid lg:grid-cols-[minmax(460px,1.08fr)_minmax(440px,.92fr)] dark:bg-[#101521] dark:text-white">
        ...
        <main className="flex min-h-screen flex-col px-5 py-6 sm:px-10 lg:px-14 xl:px-20">
          ...
          <div className="m-auto w-full max-w-md py-10">
            <div className="mb-8 lg:hidden"><img src="/images/logo-afc.png" alt="Amicale Football Club" className="mx-auto h-24 w-20 object-contain" /></div>
            ...
            <h2 className="mt-4 font-serif text-5xl">{greeting}.</h2>
            <p className="mt-4 leading-7 text-slate-500 dark:text-slate-300">Connectez-vous pour accéder aux cotisations de l&apos;Amicale Football Club.</p>
            <div className="mt-8 grid grid-cols-2 rounded-xl bg-slate-100 p-1 dark:bg-white/10" role="tablist" aria-label="Type de compte">
            ...
            {accountType==='member' && <p className="mt-6 text-sm leading-6 text-slate-500">Première connexion ? Votre mot de passe est <strong>password</strong>. En cas d&apos;oubli, contactez un administrateur.</p>}
          </div>
